...
public class HpwsClient {
    ...
    private String sendSoapRequest(String soapRequest) throws IOException {
        ...
        try {
            ...
            connection.setRequestProperty("SOAPAction", "http://hermespardini.com.br/b2b/apoio/schemas/getResultadoPedido");
    ...
    public boolean testarConexao() {
        try {
            ...
            logger.error("Falha ao testar conexão com Pardini: {}", e.getMessage());
            return false;
        }
    }
}